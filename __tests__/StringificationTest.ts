...
const dataProvider = [
  ...
  },
  {
    ...
    expectedString: 'select(id,name,age)&limit(13,100)&and(and(in(name,(string:Alfred,string:Ivan,string:Jared)),out(id,(12335,16725))),or(like(name,string:er),alike(name,string:aZa)))',
  ...
  {
    queryObject:    new Query({
      query: new Eq('united_order_id', '100920e507')
    }),
    expectedString: 'eq(united%5Forder%5Fid,string:100920e507)',
    message:        'Numbers with `e` - 100920e507, must be type of string'
  }
];
